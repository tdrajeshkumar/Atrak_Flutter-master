...
class PageCompOffRequest extends StatefulWidget {
  final GlobalKey<FormState> _formKey = new GlobalKey<FormState>();

  final void Function(String) showMessage;

  PageCompOffRequest({@required this.showMessage});

  @override
  _PageCompOffRequestState createState() => _PageCompOffRequestState();
}

class _PageCompOffRequestState extends State<PageCompOffRequest> {
  ...
  void _submit() {
    ...
    if (widget._formKey.currentState.validate()) {
      widget.showMessage("Your Comp Off request sent");
    }
  }
                  ...
                  child: IgnorePointer(
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: AtrakLocalizations.of(context).workedDate,
                        hintText: AtrakLocalizations.of(context).workedDate,
