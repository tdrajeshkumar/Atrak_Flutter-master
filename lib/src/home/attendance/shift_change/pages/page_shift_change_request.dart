...
class PageShiftChangeRequest extends StatefulWidget {
  final GlobalKey<FormState> _formKey = new GlobalKey<FormState>();

  final void Function(String) showMessage;

  PageShiftChangeRequest({@required this.showMessage});

  @override
  _PageShiftChangeRequestState createState() => _PageShiftChangeRequestState();
}

class _PageShiftChangeRequestState extends State<PageShiftChangeRequest> {
  int _fromDateSelectedItem, _toDateSelectedItem;

  final _fromDateFieldKey = GlobalKey<FormFieldState>();
  final _toDateFieldKey = GlobalKey<FormFieldState>();
  ...
  void _submit() {
    ...
    if (widget._formKey.currentState.validate()) {
      widget.showMessage("Your shift change request sent");
    }
  }
  ...
  Future _showFromDatePicker() async {
    ...
    if (selectedDate != null) {
      ...
      _fromDateFieldKey.currentState.validate();
    }
  }
  ...
  Future _showToDatePicker() async {
    ...
    if (selectedDate != null) {
      ...
      _toDateFieldKey.currentState.validate();
    }
  }
                  ...
                  children: <Widget>[
                    Flexible(
                      child: DropdownButtonFormField(
                        items: [
                          DropdownMenuItem(
                            child: Text(
                              AtrakLocalizations.of(context).oldShift,
                        ...
                        hint: Text(AtrakLocalizations.of(context).oldShift),
                        decoration: InputDecoration(
                          hintStyle: AtrakTheme.formFieldStyle,
                        ),
                      ),
                    ...
                    Flexible(
                      child: DropdownButtonFormField(
                        ...
                        hint: Text(AtrakLocalizations.of(context).newShift),
                        decoration: InputDecoration(
                          hintStyle: AtrakTheme.formFieldStyle,
                        ),
                      ),
