...
class ItemShiftChangeStatus extends StatelessWidget {
  final EmployeeShiftChangeRequestStatusEntity userStatus;

  ItemShiftChangeStatus({@required this.userStatus});
